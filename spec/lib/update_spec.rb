...
describe 'Tracking changes when update' do
  context "when enabled" do
    ...
    it 'should retrieve changes history' do
      ...
      tracked.original.should be_equal({"id"=>listing.id, "name"=>"MongoDB 102", "view_count"=>102, "location_id"=>nil, "is_active"=>nil, "description"=>nil, "created_at"=>listing.created_at.utc, "updated_at"=>listing.updated_at.utc})
    ...
    it 'should track changes with :except options' do
      ...
      listing.history_tracks.last.original.should be_equal({"id"=>listing.id, "description"=>nil, "is_active"=>nil, "view_count"=>101, "location_id"=>nil, "created_at"=>listing.created_at.utc, "updated_at"=>listing.updated_at.utc})
